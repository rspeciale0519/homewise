# HOMEWISE Brain — Schema

You maintain a self-improving engineering memory for the homewise app. The enforced
...
## Knowledge layer
homewisebrain/knowledge/<slug>.md, slug in {orientation, superseded, features,
...
## Seam
When a skill is established AND generalizable beyond homewise, propose an app-agnostic
