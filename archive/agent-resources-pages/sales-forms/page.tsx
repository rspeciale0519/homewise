...
import { SALES_FORMS } from "@/data/content/agent-resources";

export const metadata: Metadata = {
  title: "Sales Forms",
  description:
    "Download sales forms for Home Wise Realty Group agents — purchase contracts, buyer disclosures, association forms, riders, and addendums.",
};

export default function SalesFormsPage() {
  const totalDocs = SALES_FORMS.reduce(
      ...
      <div className="relative bg-gradient-to-br from-navy-800 via-navy-700 to-navy-950 overflow-hidden">
        ...
        <Container className="pt-16 pb-14 relative z-10">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center gap-2 text-xs text-slate-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-slate-300">Sales Forms</span>
              </li>
            </ol>
          </nav>
          ...
          <p className="text-slate-300 text-lg max-w-2xl leading-relaxed">
            {totalDocs} sales documents — purchase contracts, buyer disclosures, association forms, and riders.
          </p>
        </Container>
      </div>
      ...
      <div className="bg-white">
        <Container className="py-12 md:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-10 xl:gap-16 items-start">
            <DocumentList categories={SALES_FORMS} />
