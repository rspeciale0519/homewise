...
export const manualListingCreateSchema = z.object({
  ...
  county: z.string().max(100).trim().nullish().or(z.literal("")),
  ...
  description: z.string().max(8000).trim().nullish().or(z.literal("")),
  ...
  hoaFrequency: z.string().max(30).trim().nullish().or(z.literal("")),
