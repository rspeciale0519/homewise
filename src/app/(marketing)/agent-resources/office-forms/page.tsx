...
import { OFFICE_FORMS } from "@/data/content/agent-resources";

export const metadata: Metadata = {
  title: "Office Forms",
  description:
    "Download office forms and documents for Home Wise Realty Group agents — business cards, letterhead, transaction checklists, compliance forms, and more.",
};

export default function OfficeFormsPage() {
  const totalDocs = OFFICE_FORMS.reduce(
      ...
      <div className="relative bg-gradient-to-br from-navy-800 via-navy-700 to-navy-950 overflow-hidden">
        <div className="absolute inset-0 opacity-[0.04]" aria-hidden="true">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="of-grid" width="32" height="32" patternUnits="userSpaceOnUse">
                <path d="M 32 0 L 0 0 0 32" fill="none" stroke="white" strokeWidth="1" />
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#of-grid)" />
          </svg>
        </div>
        ...
        <Container className="pt-16 pb-14 relative z-10">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center gap-2 text-xs text-slate-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-slate-300">Office Forms</span>
              </li>
            </ol>
          </nav>
          ...
          <p className="text-slate-300 text-lg max-w-2xl leading-relaxed">
            {totalDocs} essential office documents — business cards, letterhead, transaction checklists, and compliance forms.
          </p>
        </Container>
      </div>
      ...
      <div className="bg-white">
        <Container className="py-12 md:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-10 xl:gap-16 items-start">
            <DocumentList categories={OFFICE_FORMS} />
            <FormsSidebar />
          </div>
        </Container>
      </div>
