                ...
                <div key={sig.id} className="flex items-center gap-4 rounded-xl border border-slate-200 bg-white p-3">
                  ...
                  {editingId !== sig.id && (
                    <div className="flex items-center gap-1 flex-shrink-0">
                      ...
                      <button onClick={() => handleDelete(sig.id)} disabled={status === "deleting"} className="p-1.5 rounded-lg text-slate-400 hover:text-crimson-600 hover:bg-crimson-50 transition-colors" title="Delete">
